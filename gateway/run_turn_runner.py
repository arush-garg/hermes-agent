...
class TurnRunner:
    ...
    def run_sync(self):
        ...
        # Cached agents retain cumulative counters; record this turn's baseline.
        usage_baseline = {
        ...
        # Final runtime identity and provider-reported usage for this logical turn.
        from gateway.run import _gateway_turn_runtime_metadata
        agent = ctx.agent_holder[0]
        usage = _gateway_turn_runtime_metadata(
            agent, **usage_baseline,
        ...
        common = {
            ...
            "error_type": result.get("error_type"), "status_code": result.get("status_code"),
            "retry_count": result.get("retry_count"), "max_retries": result.get("max_retries"),
