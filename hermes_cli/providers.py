...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "claude-cli": HermesOverlay(transport="openai_chat", auth_type="external_process",
                                extra_env_vars=("CLAUDE_CODE_OAUTH_TOKEN", "ANTHROPIC_TOKEN"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "anthropic": ("claude",), "claude-cli": ("claude-code", "claude-sub", "claude-oauth-cli"),
