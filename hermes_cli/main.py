...
def _coalesce_session_name_args(argv: list) -> list:
    ...
    _SUBCOMMANDS = {
        ...
        "memory", "dump", "debug", "backup", "import", "completion", "kickbacks", "logs",
    }
...
def _build_cli_parser():
    ...
    kickbacks_sub.add_parser("login", help="Start Kickbacks OAuth login")
    kickbacks_sub.add_parser("logout", help="Sign out from Kickbacks")
    kickbacks_sub.add_parser("status", help="Show plugin status and earnings")
    kickbacks_sub.add_parser("config", help="Show current configuration")
    kickbacks_sub.add_parser("enable", help="Enable kickbacks plugin")
    kickbacks_sub.add_parser("disable", help="Disable kickbacks plugin")
    kickbacks_sub.add_parser("demo", help="Switch to demo mode (no auth)")
    kickbacks_sub.add_parser("live", help="Switch to live mode (requires auth)")
    kickbacks_ads_parser = kickbacks_sub.add_parser("ads", help="Show cached ad details")
    kickbacks_ads_sub = kickbacks_ads_parser.add_subparsers(dest="kickbacks_ads_command")
    kickbacks_ads_sub.add_parser("list", help="Show cached ad")
