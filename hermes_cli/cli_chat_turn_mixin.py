...
class CLIChatTurnMixin:
    ...
    def _chat_setup_turn_audio(self, turn, message, voice_input):
        ...
        # The stream callback uses this flag to avoid also queueing batch TTS for a turn
        # already speaking token deltas through the streaming provider.
        self._elevenlabs_streaming_active = turn.use_streaming_tts
