...
class CLIModalMixin:
    ...
    def _clarify_callback_batch(self, questions):
        ...
        self._paint_now()
        from hermes_cli.callbacks import _send_os_notification
        first_question = questions[0]["question"] if questions else "clarifying question"
        _send_os_notification("Hermes needs your input", first_question)
    ...
    def _approval_callback(self, command: str, description: str,
        ...
        with self._approval_lock:
            ...
            if getattr(self, "_voice_tts", False):
                self._voice_tts_enqueue("Awaiting your approval.")
            from hermes_cli.callbacks import _send_os_notification
